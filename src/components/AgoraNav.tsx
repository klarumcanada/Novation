...
export default function AgoraNav() {
  ...
  const links = [
    { href: '/agora/marketplace', label: 'Marketplace', active: pathname.startsWith('/agora/marketplace') },
    { href: '/agora/profile',     label: 'My Profile',  active: pathname.startsWith('/agora/profile') },
  ]

  return (
    <nav className="mga-nav">
      <div className="mga-nav-left">
        <Link href="/agora/marketplace" className="mga-logo">
